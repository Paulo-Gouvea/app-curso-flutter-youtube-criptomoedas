...
class MoedaRepository {
  static List<Moeda> tabela = [
    ...
    Moeda(icone: 'images/usd-coin.png', nome: 'USD Coin', sigla: 'USDC', preco: 5.02,),
    Moeda(icone: 'images/litecoin.png', nome: 'Litecoin', sigla: 'LTC', preco: 669.93,),
    Moeda(icone: 'images/dogecoin.png', nome: 'Dogecoin', sigla: 'DOGE', preco: 0.69,),
    Moeda(icone: 'images/shiba-inu.png', nome: 'Shiba Inu', sigla: 'SHIB', preco: 4350000.00,),
  ];
}